...
function love.update(dt)
    ...
    elseif gameState == 'play' then
        ...
        -- if ball.y + CENTER_VALUE > player1.y + 20 then
        --     player1.dy = PADDLE_SPEED
        -- elseif ball.y - CENTER_VALUE < player1.y then
        --     player1.dy = -PADDLE_SPEED
        -- else
        --     player1.dy = 0
        -- end

        if ball.y + CENTER_VALUE > player2.y + 20 then
            player2.dy = PADDLE_SPEED
        elseif ball.y - CENTER_VALUE < player2.y then
            player2.dy = -PADDLE_SPEED
        else
            player2.dy = 0
        end
